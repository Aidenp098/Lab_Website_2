...
function loadStatsPage() {
	...
	document.getElementById("wins").innerHTML = buff_win;
		...
		switchPlayers(playerNum) method:
			...
			purpose:
				...
				Span ids:
					...
					Calculated values:
					  av(g_p_yards   - the average number of passing yards for the player's Buff career
...
function loadPlayersPage()
{
	...
	{
		option += '<a class="dropdown-item" href="#" onclick="switchPlayers('+i+')">'+players[i].name+'</a>';
	}
	document.getElementById("player_selector").innerHTML = option;
}
